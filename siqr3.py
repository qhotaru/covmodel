...
def main():
    ...
    dr = 15.0 # duration of infectiousness until recovery
    ...
    for ppx in params:
        ...
        plt.plot(t, i, label='R0={:.2f} Beta={:.2f} p={} Dq={}'.format(ppx[0]/ppx[4],ppx[0], ppx[1], 1/ppx[3]))

    plt.legend()
    plt.grid('both')
    plt.title('SEIQR'.format(beta, p))
    plt.show()
